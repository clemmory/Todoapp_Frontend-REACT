    ...
    return (
        <div className='flex items-center mb-5'>
            <DatePicker dateFormat={'dd-MM-yyyy'}
                        ...
                        name='date-picker'
                        className='appearance-none  border rounded p-2 font-semibold  text-neutral-600 bg-white outline-indigo-500'/>
                <svg    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
                        className="relative right-8 w-5 h-5 stroke-neutral-500">
