...
function ModalTodo(props) {
    ...
    const handleCloseModal = () => {
        ...
        return (
            <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-slate-600 bg-opacity-70 p-11 ">
                <div className ='w-80 sm:w-96 mb-4 bg-white border shadow rounded-lg p-8 flex flex-col'>
                    <div className = 'flex justify-between items-center mb-5'>
                        <h2 className="font-bold text-xl sm:text-2xl text-indigo-600">Edit your todo</h2>
                        <div className="flex">
                            <svg    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" 
                                    className="w-5 h-5 stroke-slate-600 hover:stroke-indigo-600 cursor-pointer mr-3"
